...
func (s immutableSeries) FillNaN(value ElementValue) {
	panic("The method[FillNaN] is not supported by immutableElement")
}
func (s immutableSeries) FillNaNForward() {
	panic("The method[FillNaNForward] is not supported by immutableElement")
}
func (s immutableSeries) FillNaNBackward() {
	panic("The method[FillNaNBackward] is not supported by immutableElement")
}
...
func (s immutableSeries) Append(values interface{}) {
	panic("The method[Append] is not supported by immutableElement")
}
